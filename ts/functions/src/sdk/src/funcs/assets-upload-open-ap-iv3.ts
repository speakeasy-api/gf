...
import { GramError } from "../models/errors/gram-error.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
...
> {
  ...
  >(
    ...
    M.jsonErr([400, 401, 403, 404, 409, 415, 422], errors.ErrorT$inboundSchema),
    M.jsonErr([500, 502], errors.ErrorT$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
