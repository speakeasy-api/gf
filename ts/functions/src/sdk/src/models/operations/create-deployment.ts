...
export type CreateDeploymentRequest = {
  ...
  body: components.CreateDeploymentRequestBody;
};
...
export type CreateDeploymentRequest$Outbound = {
  ...
  body: components.CreateDeploymentRequestBody$Outbound;
};
...
> = z.pipe(
  z.object({
    ...
    body: components.CreateDeploymentRequestBody$outboundSchema,
  }),
  z.transform((v) => {
    return remap$(v, {
      gramKey: "Gram-Key",
