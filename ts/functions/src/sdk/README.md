...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *@gram/functions-sdk* API.

[![Built by Speakeasy](https://img.shields.io/badge/Built_by-SPEAKEASY-374151?style=for-the-badge&labelColor=f3f4f6)](https://www.speakeasy.com/?utm_source=@gram/functions-sdk&utm_campaign=typescript)
...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [@gram/functions-sdk](#gramfunctions-sdk)
...
| ------------------------------ | ------ | ------- | --------------------------------------- |
| `apikeyHeaderGramKey`          | apiKey | API key | `GRAM_APIKEY_HEADER_GRAM_KEY`           |
...
[`GramError`](./src/models/errors/gram-error.ts) is the base class for all HTTP error responses. It has the following properties:
...
```typescript
import { Gram } from "@gram/functions-sdk";
import * as errors from "@gram/functions-sdk/models/errors";
import { openAsBlob } from "node:fs";
...
### Error Classes
**Primary errors:**
* [`GramError`](./src/models/errors/gram-error.ts): The base class for HTTP error responses.
  * [`ErrorT`](./src/models/errors/error-t.ts): unauthorized access.
...
**Inherit from [`GramError`](./src/models/errors/gram-error.ts)**:
...
import { HTTPClient } from "@gram/functions-sdk/lib/http";
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=@gram/functions-sdk&utm_campaign=typescript)
