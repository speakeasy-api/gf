...
```typescript
import { OAuthProxyProvider } from "@gram/functions-sdk/models/components";
...
| `providerType`                                                                                | [components.ProviderType](../../models/components/provider-type.md)                           | :heavy_check_mark:                                                                            | The type of OAuth provider                                                                    |
