...
```typescript
import { OAuthProxyServer } from "@gram/functions-sdk/models/components";
...
| `oauthProxyProviders`                                                                         | [components.OAuthProxyProvider](../../models/components/o-auth-proxy-provider.md)[]           | :heavy_minus_sign:                                                                            | The OAuth proxy providers for this server                                                     |
