...
```typescript
import { PromptTemplate } from "@gram/functions-sdk/models/components";
...
| `canonical`                                                                                   | [components.CanonicalToolAttributes](../../models/components/canonical-tool-attributes.md)    | :heavy_minus_sign:                                                                            | The original details of a tool                                                                |
...
| `kind`                                                                                        | [components.PromptTemplateKind](../../models/components/prompt-template-kind.md)              | :heavy_check_mark:                                                                            | The kind of prompt the template is used for                                                   |
...
| `variation`                                                                                   | [components.ToolVariation](../../models/components/tool-variation.md)                         | :heavy_minus_sign:                                                                            | N/A                                                                                           |