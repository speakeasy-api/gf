...
```typescript
import { CreateDeploymentRequest } from "@gram/functions-sdk/models/operations";
...
| `body`                                                                                              | [components.CreateDeploymentRequestBody](../../models/components/create-deployment-request-body.md) | :heavy_check_mark:                                                                                  | N/A                                                                                                 |                                                                                                     |